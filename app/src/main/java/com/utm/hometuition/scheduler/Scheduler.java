package com.utm.hometuition.scheduler;
import javax.swing.JOptionPane;

import com.utm.hometuition.model.Parent;
import com.utm.hometuition.model.Session;
...
public class Scheduler {
    ...
    public void loadTutors(String filename) {
        try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
            ...
            JOptionPane.showMessageDialog(null, "Info: tutors.txt not found, starting fresh.", "File Info", JOptionPane.INFORMATION_MESSAGE); 
        }
    }
    ...
    public void loadParents(String filename) {
        try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
            ...
            JOptionPane.showMessageDialog(null, "Info: parents.txt not found, starting fresh.", "File Info", JOptionPane.INFORMATION_MESSAGE); 
        }
    }
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts.length == 5) {
                    ...
                    if (foundTutor != null && foundParent != null) {
                        ...
                        JOptionPane.showMessageDialog(null, "Warning: Could not link session. Profile for Tutor '" + parts[0] + "' or Parent '" + parts[1] + "' not found.", "Data Warning", JOptionPane.WARNING_MESSAGE);
                    }
                }
            }
        } catch (IOException e) { 
            JOptionPane.showMessageDialog(null, "Info: sessions.txt not found, starting fresh.", "File Info", JOptionPane.INFORMATION_MESSAGE); 
        }
    }
}